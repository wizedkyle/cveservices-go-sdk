...
func (a *APIClient) prepareRequest(
	...
	if a.Cfg.Authentication.APIUser != "" && a.Cfg.Authentication.APIKey != "" && a.Cfg.Organization != "" {
		localVarRequest.Header.Add("CVE-API-USER", a.Cfg.Authentication.APIUser)
		localVarRequest.Header.Add("CVE-API-KEY", a.Cfg.Authentication.APIKey)
		localVarRequest.Header.Add("CVE-API-ORG", a.Cfg.Organization)
	}
