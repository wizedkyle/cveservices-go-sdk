...
Retrieves an organization record. No roles are needed to access the endpoint.
Expected Behavior:
...
*/
func (a *APIClient) GetOrganizationRecord() (types.Organization, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue types.Organization
	)
